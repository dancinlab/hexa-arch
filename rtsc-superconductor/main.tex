...
\clearpage
\appendix
\input{appendix/A_mcmillan}
\input{appendix/B_allen_dynes}
\input{appendix/C_material_verdict}
\input{appendix/D_hydride_candidates}
\input{appendix/E_getdp_solenoid}
\input{appendix/F_wheeler_crosscheck}
\input{appendix/G_elph_inputs}
\input{appendix/H_verify_ledger}
\input{appendix/I_pr_roll}
\input{appendix/J_reproducibility}
