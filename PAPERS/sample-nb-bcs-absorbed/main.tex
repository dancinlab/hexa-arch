...
\author{
  demiurge / hexa-lang substrate authors\thanks{Corresponding repo:
  \url{https://github.com/dancinlab/demiurge}, \url{https://github.com/dancinlab/hexa-lang}.}
}
...
even be considered for absorption:
...
\begin{tikzpicture}[scale=2.4]
  % horizontal axis
  \draw[->, thick] (0,0) -- (4.4,0) node[right] {$2\Delta(0)/k_{B}T_{c}$};
  \foreach \x in {3.30,3.40,3.50,3.60,3.70} {
    \draw (\x-3.30,0.04) -- (\x-3.30,-0.04) node[below,font=\scriptsize] {\x};
  }
  % BCS prediction (vertical line)
  \draw[blue!70!black, very thick, dashed]
    (3.5276-3.30,-0.25) -- (3.5276-3.30,0.45)
    node[above,font=\scriptsize\bfseries, color=blue!70!black] {BCS: 3.5276};
  % Measurements
  \foreach \r/\s/\y/\lbl in {
    3.50/0.10/0.05/Giaever '60,
    3.55/0.05/0.13/Townsend '62,
    3.50/0.05/0.21/Schwidtal '69,
    3.52/0.04/0.29/Lichtenberg '89,
    3.50/0.05/0.37/Tinkham '96
  } {
    \draw[honestred, thick] (\r-3.30-\s,\y) -- (\r-3.30+\s,\y);
    \draw[honestred,fill=white,very thick] (\r-3.30,\y) circle (0.014);
    \node[anchor=west,font=\scriptsize] at (1.1,\y) {\lbl};
  }
  % consensus (yellow band)
  \draw[honestgreen, thick] (3.5169-3.30-0.0228,-0.10) -- (3.5169-3.30+0.0228,-0.10);
  \draw[honestgreen,fill=honestgreen!20,very thick] (3.5169-3.30,-0.10) circle (0.018);
  \node[anchor=west,font=\scriptsize\bfseries,color=honestgreen] at (1.1,-0.10) {Consensus: 3.5169 $\pm$ 0.0228};
  % threshold band
  \draw[gray, thin, dotted] (3.5276*0.95-3.30,-0.18) -- (3.5276*0.95-3.30,0.43);
  \draw[gray, thin, dotted] (3.5276*1.05-3.30,-0.18) -- (3.5276*1.05-3.30,0.43);
  \node[anchor=south, font=\scriptsize, color=gray] at (3.5276-3.30,0.45) {};
  \node[anchor=north, font=\scriptsize, color=gray, align=center] at (3.5276-3.30,-0.18) {$\tau=5\%$ band};
\end{tikzpicture}
\caption{Five independent measurements (red bars, with $\pm\sigma$),
their inverse-variance consensus (green), and the parameter-free BCS
prediction (blue dashed). The dotted vertical lines bound the
pre-registered \(5\%\) threshold around the prediction. Relative
error of the consensus is \(0.309\%\).}
\label{fig:consensus}
\end{figure}
