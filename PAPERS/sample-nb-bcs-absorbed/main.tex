...
\paragraph{Empirical resolution of the LK-99 signal.}
Independent analyses through 2023-Q3/Q4 attributed the originally
reported sharp resistivity drop near $385\,K$ and the ferromagnetic
levitation behaviour to a {Cu}$_{2}${S} impurity phase transition
($\beta \to \alpha$ first-order, $\approx 385\,K$) rather than bulk
superconductivity \cite{jain2023lk99cu2s,zhu2023lk99cu2s}. This
explanation is consistent with the four-source refusal above: the
claim was \emph{not} a measurement-error retraction but a misattributed
impurity signature --- a distinction the substrate captures via
\texttt{replicated\_by\_independent\_labs}\,\(=\,0\) on the Tier 2
recipe record and the negative MP curation row. Annotation added
2026-05-22 (honest-scrub pass; substrate behaviour unchanged).
