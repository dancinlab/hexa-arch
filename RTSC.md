...
| **H₃X group 14-17 parallel fanout** (8 후보 — h3o · h3f · h3n · h3si · h3p · h3cl · h3as · h3br) | ⏳ **in-progress 3/8 LANDED** — **h3cl 완주** (6³q · λ_BZ=1.14–1.41 · ω_log=1250–1254 K · Tc(μ=0.10)=105–134 K · celldm=5.659 · 🔴 §9.15 FAIL above pred 25-60) · **h3f 완주** (6³q · λ_BZ=0.81–0.82 · ω_log=652–670 K · Tc(μ=0.10)=31–33 K · celldm=5.127 · 🔴 §9.15 FAIL below pred 50-100) · **h3si 완주** (6³q · λ_BZ=1.72–1.82 · ω_log=572–624 K · Tc(μ=0.10)=77–80 K · celldm=5.656 · 🟢 §9.15 PASS pred 50-110) · artifacts `~/etc/rtsc-results/{h3cl,h3f,h3si}/` · 나머지 5개 pod 진행 중 (h3o/h3n/h3p/h3as/h3br) | group 14/15/16/17 의 H₃X 패턴 sweep · novel-prediction 영역 (§9.10 N5 의 candidate funnel pattern) · **d7 wall 메커니즘 정확 식별**: ALIGNN per-cand H₃Cl λ=0.81 vs DFT 1.27 (+57% 차) — λ-magnitude 가 아니라 **ω_log 15× under (81 K vs 1252 K)** 가 dominant ML failure mode (고압 H-derived 고진동 모드 ambient-ML training 부재). family-wide 미분화 가설 부분 falsify, wall 강화. |
