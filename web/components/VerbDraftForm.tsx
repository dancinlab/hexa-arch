...
export function VerbDraftForm(props: VerbDraftFormProps) {
  ...
  return (
    <div className="space-y-4">
      <form onSubmit={submit} className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <button
            type="submit"
            disabled={loading}
            className="rounded-control bg-primary px-3 py-1 text-sm text-surface disabled:opacity-40"
          >
            {loading
              ? "Gemini 호출 중..."
      ...
      {error && (
        <div className="rounded-control border border-danger bg-surface p-3 text-sm text-danger">
      ...
      {result && (
        <div className="space-y-2">
          <div className="rounded-panel border border-hairline bg-surface-strong p-3">
