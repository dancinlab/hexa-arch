...
|---|---|---|
| ~~Geant4-MC tooling 벽~~ ✅ **돌파**(2026-05-26 #239) — Geant4 11.3.2 + particle 설치·smoke PASS (ubu-1 conda `geant4`) | ~~trampoline segfault~~ → conda-forge 공식 빌드(ABI-매칭 바인딩)로 우회 | **Stage 4 4-보정 parity 본해**(runnable · in-scope 승격) — 다음 라운드 |
...
│               Geant4-MC          → ◐ Geant4 11.3.2 설치(#239) · Stage 4 parity 다음
...
| 검증 VERIFY | **Geant4** · elegant · MAD-X survey | ✓ Bethe-Bloch hexa-native · ◐ Geant4-MC (11.3.2 설치 #239, Stage 4 다음) |
...
| Geant4 cell | ◐ particle 0.26.2 + Geant4 11.3.2 설치(#239 · ubu-1 conda `geant4`) — Stage 4 parity 본해 다음 라운드 |
...
- [ ] Bethe-Bloch Stage 4 — Geant4-MC 4-보정(shell·density·straggling·nuclear) parity → absorbed 판정 · **이제 runnable**(Geant4 #239 설치 완료, ubu-1 `conda activate geant4`) — 다음 라운드 dispatch
